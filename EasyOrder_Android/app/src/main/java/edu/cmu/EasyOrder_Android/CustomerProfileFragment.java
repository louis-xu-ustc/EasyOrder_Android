...
public class CustomerProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListView = (ListView) rootView.findViewById(R.id.customer_history_order);
        historyOrderAdapter = new CustomerHistoryOrderAdapter(getContext(), R.layout.customer_history_order_view, historyOrderArrayList);
