...
public class RetailerMainActivity extends AppCompatActivity implements
    ...
    private static final String TAG = RetailerMainActivity.class.getSimpleName();
...
//        setButtonsEnabledState();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_retailer_main, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.retailer_fragment_main, container, false);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new RetailerPostFragment();
                case 1:
...
//            setButtonsEnabledState();
    ...
    private void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : Constants.CMU_AREA_LANDMARKS.entrySet()) {
    ...
    private void setButtonsEnabledState() {
        if (getGeofencesAdded()) {
            Toast.makeText(getApplicationContext(), "Geofencing alreay on!", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getApplicationContext(), "Geofencing alreay off!", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(RetailerMainActivity.this,
