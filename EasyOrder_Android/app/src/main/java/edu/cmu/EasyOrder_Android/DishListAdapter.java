...
public class DishListAdapter extends ArrayAdapter<Dish> {
    ...
    public DishListAdapter(Context context, int textViewResourceId, ArrayList<Dish> objects) {
